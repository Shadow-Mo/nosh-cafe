  ...
  return (
    <section id="home" className="min-h-screen flex items-center bg-[url('/images/noshbg.webp')] bg-cover bg-center bg-fixed relative overflow-hidden">
      ...
      <div className="max-w-[60rem] relative z-10 px-5 animate-fadeIn">
        ...
        <Link href="#menu" className="mt-[2rem] inline-block py-[1.2rem] px-[3.5rem] text-[1.7rem] text-white bg-[#d3ad7f] hover:tracking-[0.2rem] transition-all rounded-md shadow-lg hover:shadow-xl hover:bg-[#c29c6d] animate-fadeIn delay-300 uppercase font-medium">
          View Menu
        </Link>
      </div>
    </section>
